...
AnnoJ.Navigator = function() {
	...
	var Toolbar = new Ext.Toolbar({
		...
		items: [ Controls.dragMode, '  |  ', 'Zoom level: ',Controls.ratio, Controls.further, Controls.closer, '  |  ', 'Chromosome:',Controls.assembly,'Position:', Controls.jump, Controls.go,'  |  ', Controls.prev, Controls.next, '  |  ', Controls.scaleMode]
	...
	*/
	...
	items: [{
		...
		/*},							//removed by H. C. 2015-06-21
		{
			height: 24,
			style: 'margin: 0px; padding: 0px;',
			items: [' ', Controls.jumpLeft, '->', Controls.jumpRight]
		...
		*/
		...
		// 	height: 24,
		// 	style: 'margin: 0px; padding: 0px;',
		// 	items: [' ', Controls.jumpLeft, ' ', '-', 'Analyses:', ' ', runMerge, ' ', runIntersection, ' ', runSummation, ' ', runSubtract, '->', Controls.jumpRight, ' ']
		// 	//items: [' ', Controls.jumpLeft, ' ', '-', 'Analyses:', ' ', runMerge, runIntersection, runSummation, runSubtract, runIntensity, runCorrelation, runPeakcall, '->', Controls.jumpRight, ' ']
		// }
	]
	});
