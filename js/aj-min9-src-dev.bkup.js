...
AnnoJ.Navigator = function() {
	...
	var Toolbar = new Ext.Toolbar({
		...
		items: [Controls.jumpLeft, ' ', 'Baseline', Controls.Baseline, ' ', Controls.showMode, ' ', Controls.scaleMode, ' ', Controls.activateMode, ' ', 'Multi', Controls.scaleBox, 'Y-axis', Controls.GlobalscaleBox,'-', Controls.dragMode, ' ', Controls.ratio, Controls.further, Controls.closer, ' ', Controls.assembly, Controls.jump, Controls.go, Controls.prev, Controls.next, '->', Controls.jumpRight]
	...
	*/
	...
	items: [{
			...
			height: 24,
			style: "margin: 0px; padding: 0px;", 
			items: [headBricks, '<b><font color=#15428b>Tracks : </font></b>', ' ', Controls.info, Controls.title]
		},
		{
			height: 25,
			style: 'margin: 0px; padding: 0px;',
