...
Ext.apply = function(d, e, b) {
	...
	Ext.apply(Ext, {
		...
		function() {
			var e;
			return function(C) {
				if (C && C.tagName != "BODY") { (Ext.enableNestedListenerRemoval) ? Ext.EventManager.purgeElement(C, true) : Ext.EventManager.removeAll(C);
			...
			if (e && e.parentNode && e.tagName != "BODY") { (Ext.enableNestedListenerRemoval) ? Ext.EventManager.purgeElement(e, true) : Ext.EventManager.removeAll(e);
...
Ext.TaskMgr = new Ext.util.TaskRunner(); (function() {
	...
	Ext.lib.Point.prototype = new Ext.lib.Region(); (function() {
		var g = Ext.lib,
		...
		g.AnimBase.prototype = {
			...
			init: function(l, p, o, k) {
				...
				r.onComplete = new Ext.util.Event(r); (r._onStart = new Ext.util.Event(r)).addListener(t); (r._onTween = new Ext.util.Event(r)).addListener(q); (r._onComplete = new Ext.util.Event(r)).addListener(m)
			}
		};
		Ext.lib.AnimMgr = new
		function() {
