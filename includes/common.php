...
//Security checking. Only allow certain users
//include '../../access.php';
include 'logger.php';
...
$user = 'cndd_annoj';
$pass = 'jonna_ddnc';
//$cache_dir = '/home/julian/public_html/aj_caches2/';
$cache_dir = '/var/www/html/annoj/aj_caches/';
...
if ($action == 'range')
{
	...
	$smoothing   = isset($_GET['smoothing'])   ? clean_int($_GET['smoothing'])      : false;
